...
namespace SessionState.Examples.Services;

/// <summary>
/// Demo cookie authentication events to verify that EventsType works with SessionState.
/// </summary>
...
/// </summary>
public class DemoKeyGenerator : ISessionStateKeyGenerator
{
