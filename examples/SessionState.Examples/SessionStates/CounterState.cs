// SessionState.Examples/SessionStates/CounterState.cs
using SessionState;
using SessionState.Core;
using SessionState.Core.Options;

namespace SessionState.Examples.SessionStates;

public sealed class CounterState : SessionStateTypeBase<CounterState>, ISessionStateType<CounterState>
{
