...
using BlazorState.Examples.Services;
using BlazorState.Examples;
...
builder.Services.AddBlazorState<DemoKeyGenerator>()
    .WithInMemoryBackend()
...
builder.Services.AddAuthentication("Cookies")
    ...
    .WithBlazorState("Cookies"); // Integrate with BlazorState
