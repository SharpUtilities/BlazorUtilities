...
/// <summary>
/// Backend storage abstraction for SessionAndState.
...
/// Events are handled by the SessionAndState infrastructure.
/// </remarks>
public interface ISessionAndStateBackend
{
    /// <summary>
    ...
    /// </summary>
    ValueTask<IReadOnlyList<RemovedSessionStateInfo>> RemoveAllForKeyAsync(string sessionKey, CancellationToken cancellationToken = default);
