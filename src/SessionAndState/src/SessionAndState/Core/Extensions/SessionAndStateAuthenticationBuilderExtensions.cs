...
/// <summary>
/// Extension methods for integrating SessionAndState with authentication.
/// </summary>
public static class SessionAndStateAuthenticationBuilderExtensions
{
    /// <summary>
    /// Adds SessionAndState integration to cookie authentication.
    ...
    public static AuthenticationBuilder WithSessionAndState(
