...
internal sealed class SessionAndStateAsyncLocalAccessor
{
    private static readonly AsyncLocal<SessionAndStateHolder> _current = new();
    ...
    public void Set(string sessionKey, bool isAuthenticated)
    {
        ...
        _current.Value = new SessionAndStateHolder
        {
    ...
    private sealed class SessionAndStateHolder
    {
