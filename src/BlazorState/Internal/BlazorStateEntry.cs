...
/// </summary>
internal sealed class BlazorStateEntry
{
    ...
    /// </summary>
    public BlazorStateEntry WithLastAccessed(DateTimeOffset now) => new()
    {
        Value = Value,
        CreatedAt = CreatedAt,
        LastAccessedAt = now,
    ...
    /// </summary>
    public BlazorStateEntry WithValue(object value, DateTimeOffset now) => new()
    {
        Value = value,
        CreatedAt = CreatedAt,
        LastAccessedAt = now,
