...
/// </summary>
/// <remarks>
/// You must still implement the static expiration properties from <see cref="IBlazorStateType{T}"/>
...
public abstract class BlazorStateTypeBase<T> : INotifyPropertyChanged, IEquatable<T>
    where T : BlazorStateTypeBase<T>, IBlazorStateType<T>
{
