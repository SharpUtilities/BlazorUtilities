using BlazorState.Internal.Auth;
...
/// <summary>
/// Extension methods for integrating BlazorState with authentication.
/// </summary>
public static class BlazorStateAuthenticationBuilderExtensions
{
    /// <summary>
    /// Adds BlazorState integration to cookie authentication.
    ...
    public static AuthenticationBuilder WithBlazorState(
        ...
        string authenticationScheme)
    {
        ...
        builder.Services.AddOptions<CookieAuthenticationOptions>(authenticationScheme)
            .PostConfigure<IServiceProvider>((cookieOptions, services) =>
            {
                ...
                cookieOptions.Events = new BlazorStateCookieAuthenticationEvents(
                    existingEvents,
                    existingEventsType);
