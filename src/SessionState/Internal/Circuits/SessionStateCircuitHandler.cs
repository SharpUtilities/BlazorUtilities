...
namespace SessionState.Internal.Circuits;
...
/// </summary>
internal sealed partial class SessionStateCircuitHandler : CircuitHandler
{
    private readonly ISessionStateSessionManager _sessionManager;
    private readonly ILogger<SessionStateCircuitHandler> _logger;

    public SessionStateCircuitHandler(
        ISessionStateSessionManager sessionManager,
    ...
    public override async Task OnCircuitOpenedAsync(Circuit circuit, CancellationToken cancellationToken)
    {
        ...
        await _sessionManager.EstablishSessionAsync(cancellationToken);
