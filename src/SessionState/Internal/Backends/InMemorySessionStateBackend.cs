...
namespace SessionState.Internal.Backends;

/// <summary>
/// In-memory implementation of ISessionStateBackend.
/// Suitable for single-server deployments.
/// </summary>
internal sealed partial class InMemorySessionStateBackend : ISessionStateBackend
{
    ...
    private readonly ILogger<InMemorySessionStateBackend> _logger;

    public InMemorySessionStateBackend(
        SessionStateTimeProvider timeProvider,
        ILogger<InMemorySessionStateBackend> logger)
    {
    ...
    public ValueTask RemoveAllForKeyAsync(string sessionKey, CancellationToken cancellationToken = default)
    {
        var removedCount = 0;
        ...
        if (removedCount > 0)
        {
            LogRemovedEntriesForSessionKey(removedCount);
        }
